...
$query = "SELECT id, Norden, SerieDoc, Concepto, Proveedor, NExpSIAF, Fecha, FecOtoBPro, Monto, TipoProceso, Ncontrato, Convocatoria, Objeto, Ncaja, Nexpediente, CntFolios, Anio, PDF, OBSERVACIONES FROM  table_all WHERE Concepto
